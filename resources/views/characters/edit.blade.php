        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('characters.update', ['character' => $character, 'project' => $project->id]) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="role" name="role" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <option value="Protagonista" {{ old('role', $character->role) === 'Protagonista' ? 'selected' : '' }}>Protagonista</option>
                                    <option value="Antagonista" {{ old('role', $character->role) === 'Antagonista' ? 'selected' : '' }}>Antagonista</option>
                                    <option value="Mentor" {{ old('role', $character->role) === 'Mentor' ? 'selected' : '' }}>Mentor</option>
                                    <option value="Aliado" {{ old('role', $character->role) === 'Aliado' ? 'selected' : '' }}>Aliado</option>
                                    <option value="Personagem" {{ old('role', $character->role) === 'Personagem' ? 'selected' : '' }}>Personagem</option>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea id="goals" name="goals" 
                                          class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                          rows="3" placeholder="O que o personagem deseja alcançar?">{{ old('goals', $character->goals) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="fears" name="fears" 
                                          class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                          rows="3" placeholder="Do que o personagem tem medo?">{{ old('fears', $character->fears) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea id="history" name="history" 
                                          class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                          rows="4" placeholder="Passado e background do personagem">{{ old('history', $character->history) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="personality" name="personality" 
                                          class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                          rows="4" placeholder="Traços de personalidade, comportamento">{{ old('personality', $character->personality) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" 
                                      class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                      rows="3" placeholder="Outras informações relevantes">{{ old('notes', $character->notes) }}</textarea>
