...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full">
    <head>
        ...
        <link href="https://fonts.bunny.net/css?family=figtree:400,500,600&family=inter:400,500,600,700&family=source-serif-pro:400,600,700&display=swap" rel="stylesheet" />
